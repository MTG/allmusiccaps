#!/bin/bash
# Launch SLURM jobs to evaluate losses-group models at step=80000.
# Run from the cluster login node: bash scripts/launch_step80k_eval.sh
#
# NOTE: ny6g2bzr is excluded — it only trained to step=47304 (no 80k checkpoint).
...
# Models missing only probing tasks at step=80000
for mid in R08 z0r7jh5a f9l9z22m; do
...
# R14: missing all tasks at step=80000
mid=R14
...
echo ""
echo "NOTE: ny6g2bzr excluded (max checkpoint is step=47304)"
